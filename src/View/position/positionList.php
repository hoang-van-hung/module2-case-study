<table class="employee-list">
    ...
    <?php foreach ($position_list as $key=> $position): ?>
        <tr>
            ...
            <td><button><a href="index.php?page=position-update&id=<?php echo $position[0]['ma_chuc_vu']; ?>">Update</a></button></td>
            <td><button><a href="index.php?page=position-delete&id=<?php echo $position[0]['ma_chuc_vu']; ?>">Delete</a></button></td>
        </tr>
    <?php endforeach; ?>
